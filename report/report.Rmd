...
```
De seguida, procedeu-se à preparação do dados para a realização do PCA. Fez-se a substituição dos nomes das amostras (id dos pacientes) no conjunto de dados pelos valores da coluna "expr". Pois, permitirá enriquecer a análise de PCA ao incorporar informações contextuais sobre as amostras.
