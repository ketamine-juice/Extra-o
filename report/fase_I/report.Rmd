...
Vamos testar com o top 100, 500, 1000, 10000 e total

A lógica será ver se há diferenças significativas nos modelos e se é introduzida variabilidade suficiente nos perfis para ter maior granulometria.

Top 100, 500 e 1000, 1000 e total em random forest tem sempre uma accuracy de 100% o que é suspeito pois não é plausível considerar um modelo que acerte 100% das vezes, mesmo com cross validation e bootstraping. Isto pode estar relacionado com o facto de o dataset não ser grande o suficiente, pelo que seria importante utilizar mais amostras ou um data set mais extenso.

Para o MLP vemos diferenças, tendo o modelo uma accuracy de 100% para top 100, 500 e 1000 mas começando a reduzir a accuracy com maior número de genes nos perfis. Isto já é um comportamento mais ajustado à realidade, sobretudo sendo que o maior elemento de confusão está entre os tipos TRU e prox.-prolif que são os que têm o perfil de expressão mais semelhante em alguns genes como é possível ver nos heatmaps. O modelo com melhores resultados foi o testado em 10000

É aqui que testamos o model mix em que cruzamos random forests e mlp para obtenção de resultados mais fiáveis.
...
```{r}
#luad.rf.19529$finalModel
#luad.rf.19529$results
pred.rf.19529 = predict(luad.rf.19529,testData[,interv])
