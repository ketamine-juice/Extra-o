...
meta = data.frame(sample_id = luad_data$patient, tumour_stage = luad_data$paper_Tumor.stage)
```
...
```
Na secção abaixo são desenhados heatmaps que visam comparar a expressão de genes em diferentes estágios.
