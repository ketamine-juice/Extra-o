...
### 3.4.1 Para o coeficiente "genderfemale"
...
summary(de <- decideTestsDGE(lrt.BvsL))
```
Podemos concluir que não foram encontradas diferenças significativas entre a expressão genética entre o género feminino e masculino. 
