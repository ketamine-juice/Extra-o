...
col.cell1 = c("purple","orange", "green")[meta$expr[1:50]]
...
col.cell2 = c("purple","orange", "green")[meta$expr[51:100]]
heatmap.2(highly_variable_lcpm[,51:100], 
          col=rev(morecols(50)),
          trace="column", 
          main="Top 10 most variable genes across samples",
          ColSideColors=col.cell2,scale="row")

col.cell3 = c("purple","orange", "green")[meta$expr[101:150]]
heatmap.2(highly_variable_lcpm[,101:150], 
          col=rev(morecols(50)),
          trace="column", 
          main="Top 10 most variable genes across samples",
          ColSideColors=col.cell3,scale="row")

col.cell4 = c("purple","orange", "green")[meta$expr[151:200]]
heatmap.2(highly_variable_lcpm[,151:200], 
          col=rev(morecols(50)),
          trace="column", 
          main="Top 10 most variable genes across samples",
          ColSideColors=col.cell4,scale="row")

col.cell5 = c("purple","orange", "green")[meta$expr[201:242]]
heatmap.2(highly_variable_lcpm[,201:242], 
          col=rev(morecols(50)),
          trace="column", 
          main="Top 10 most variable genes across samples",
          ColSideColors=col.cell5,scale="row")
```
